 ...
 */
public class LanguageFrame extends javax.swing.JInternalFrame implements InternalFrameListener {

    private static LanguageFrame INSTANCE = null;
    DefaultListModel model = new DefaultListModel();
    /**
     * Creates new form FieldtypeFrame
     */
    private LanguageFrame() {
        initComponents();
        this.addInternalFrameListener( this );
    }
    
    public static LanguageFrame getInstance() {
        if (INSTANCE == null) {
            INSTANCE = new LanguageFrame();
        }
        return INSTANCE;
    }
    ...
    private void initComponents() {
        ...
        listLanguages = new javax.swing.JList<>();
        ...
        listLanguages.setModel(model);
        listLanguages.setSelectionMode(javax.swing.ListSelectionModel.SINGLE_SELECTION);
        jScrollPane1.setViewportView(listLanguages);
    ...
    private javax.swing.JList<LanguageBean> listLanguages;
    ...
    private void updateList() {
        ...
        this.model.addAll( Arrays.asList( LanguageBean.values() ));
    }
    ...
    private void addFieldtype() {
        String newName = JOptionPane.showInputDialog(MainWindow.getInstance().getJDesktopPane(), "Name for Field type?", "");        
         if (newName != null && !newName.trim().equals("")) {
            ...
            LanguageBean newBean = new LanguageBean( newName );
            LanguageBean.saveXml(newBean, LanguageBean.createFile(newBean) );
            this.updateList();
        }
    }

    private void renameFieldtype() {
        if (this.listLanguages.getSelectedValue() != null) {
            LanguageBean selectedBean = this.listLanguages.getSelectedValue();
    ...
    private void removeFieldtype() {
        if (this.listLanguages.getSelectedValue() != null) {
            LanguageBean bean = this.listLanguages.getSelectedValue();
